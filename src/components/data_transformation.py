...
@dataclass
class DataTransformationConfig:   #Provide any input that need for data transformation component
        ...
        try:
            ...
            num_pipeline = Pipeline(
                steps = [
                    ...
                    ("scaler",StandardScaler(with_mean=False))                     #Standertize
                ]
            )
            ...
            preprocessor= ColumnTransformer(
                [
                    ("num_pipeline",num_pipeline,numerical_columns),  #(pipeline_name, what pipeline it is, columns)
